...
exports.HomeEndpoint = void 0;
const fs_1 = require("fs");
const HttpUtils_1 = require("../utils/HttpUtils");
const Logger_1 = __importDefault(require("../utils/Logger"));
const Endpoint_1 = require("./Endpoint");
class HomeEndpoint extends Endpoint_1.Endpoint {
    get(_) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                Logger_1.default.info("Serving home page");
                const html = yield fs_1.promises.readFile("../../views/index.html", {
                    encoding: "utf-8",
                });
...
exports.HomeEndpoint = HomeEndpoint;

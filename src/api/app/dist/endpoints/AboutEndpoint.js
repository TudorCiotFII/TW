...
exports.AboutEndpoint = void 0;
const fs_1 = require("fs");
const Endpoint_1 = require("./Endpoint");
const HttpUtils_1 = require("../utils/HttpUtils");
const Logger_1 = __importDefault(require("../utils/Logger"));
class AboutEndpoint extends Endpoint_1.Endpoint {
    get(request) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                Logger_1.default.info("Serving about page");
                const html = yield fs_1.promises.readFile("../../views/about.html", {
                    encoding: "utf-8",
                });
...
exports.AboutEndpoint = AboutEndpoint;

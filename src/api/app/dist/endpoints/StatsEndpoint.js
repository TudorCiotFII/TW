...
class StatsEndpoint extends Endpoint_1.Endpoint {
    constructor() {
        super(...arguments);
    ...
    get(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const html = yield fs_1.promises.readFile("../../views/statistics.html", {
                encoding: "utf-8",
            });
...
exports.StatsEndpoint = StatsEndpoint;
